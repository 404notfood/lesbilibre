    ...
    return (
        <>
            <Head title="LesbiLibre · Pour celles qui savent">
                ...
                <meta
                    name="description"
                    content="LesbiLibre — Rencontres lesbiennes. Pour celles qui aiment les femmes. Désir, complicité, vertige."
                />
            </Head>
    ...
    return (
        ...
        >
            ...
            <motion.div
                aria-hidden
                style={{ y: y2, opacity }}
                className="pointer-events-none absolute -right-12 top-32 z-0 select-none"
            >
                <span className="font-display block leading-none text-[28vw] font-light italic tracking-tighter text-foreground/[0.035] sm:text-[22vw]">
                    enfin.
                </span>
            </motion.div>
            ...
            <div className="container-editorial relative z-10 w-full">
                <div className="absolute left-6 top-0 hidden h-full items-center sm:flex lg:left-16">
                ...
                <div className="relative">
                    ...
                    <motion.h1
                        ...
                        className="font-display max-w-[16ch] text-[clamp(3.5rem,11vw,11rem)] font-light leading-[0.88] tracking-[-0.04em] text-foreground"
                    >
                        <span className="block">Aimer une</span>
                        <span className="block">
                            <em className="not-italic">
                                <span className="italic text-primary">femme</span>,
                            </em>
                        </span>
                        <span className="block">
                            <em className="italic font-light text-foreground/85">sans détour.</em>
                        </span>
                    </motion.h1>
                    ...
                    <div className="mt-12 grid gap-12 lg:grid-cols-12 lg:gap-8">
                        ...
                        >
                            ...
                            Une histoire d&apos;un soir. Une amitié qui dérape, ou pas. Une vie à
                            deux. Une curiosité. Un fantasme tenu trop longtemps. Tout est légitime
                            ici — et rien n&apos;est jugé.
                        </motion.p>
                        ...
                        >
                            ...
                            <p className="editorial-caption mt-3 text-foreground/40">
                                Gratuit · Pas de carte · Pas de hommes
                            </p>
                        </motion.div>
                    </div>
                    ...
                    >
                        <MetaCell label="Membres" value={stats?.total_users ?? 0} />
                        <MetaCell label="Connectées aujourd’hui" value={stats?.active_today ?? 0} pulse />
                        <MetaCell label="Rencontres au total" value={stats?.total_matches ?? 0} />
...
function MetaCell({
    ...
    const display = raw ?? (value !== undefined ? value.toLocaleString('fr-FR') : '—');
    return (
                        ...
                        {words.map((w, i) => (
                            <span
                                ...
                                className={`font-display text-3xl font-light italic md:text-5xl ${
                                    w === '·' ? 'text-primary' : 'text-foreground/85'
                                }`}
                            >
                                {w}
                            </span>
                ...
                <div className="lg:col-span-5">
                    <div className="sticky top-32">
                        ...
                        <h2 className="font-display text-5xl font-light leading-[0.95] tracking-tight md:text-7xl">
                            ...
                            <em className="italic text-primary"> à t&apos;expliquer</em>.
                        </h2>
                        <p className="mt-8 max-w-md text-foreground/65">
                            On a fait LesbiLibre parce qu&apos;on en avait marre des apps où il
                            fallait préciser. Préciser qu&apos;on ne voulait pas de mecs. Préciser
                            qu&apos;on n&apos;était pas là pour leur fantasme. Préciser. Toujours
                            préciser.
                        </p>
                    </div>
                </div>
...
function ManifestoCard({
    ...
    return (
        ...
        >
            ...
            <p className="mt-4 max-w-prose pl-12 text-foreground/70 md:text-lg">{d}</p>
            <span className="absolute right-0 top-8 hidden h-px bg-primary/40 transition-all duration-700 group-hover:w-16 md:block md:w-0" />
        </motion.article>
    );
}
            ...
            <div className="container-editorial">
                <div className="mb-20 flex items-end justify-between gap-12">
                    <div>
                        ...
                        <h2 className="font-display max-w-2xl text-5xl font-light leading-[0.95] tracking-tight md:text-7xl">
                            Elles ont dit
                            <em className="italic text-primary"> oui</em>.
                        </h2>
                    </div>
...
function VoiceCard({
    ...
    return (
        ...
        >
            ...
            <div>
                <span className="font-display block text-7xl font-light italic leading-none text-primary/80">
                    «
                </span>
                <blockquote className="font-display mt-2 text-2xl font-light leading-snug tracking-tight text-foreground md:text-3xl">
                    {q}
                </blockquote>
            </div>

            <footer className="mt-10 flex items-baseline gap-4 border-t border-border/40 pt-4">
                <span className="font-display text-xl italic text-foreground">{who}</span>
                <span className="editorial-caption text-foreground/50">{where}</span>
            </footer>
        </motion.div>
    );
}
        ...
        <section id="how-it-works" className="relative py-32 md:py-48">
            <div className="container-editorial">
                <div className="mb-24 max-w-3xl">
                    ...
                    <h2 className="font-display text-5xl font-light leading-[0.95] tracking-tight md:text-7xl">
                        Quatre temps,
                        <em className="italic text-primary"> aucune urgence</em>.
                    </h2>
                </div>
                ...
                <div className="grid gap-x-12 gap-y-20 md:grid-cols-2 lg:grid-cols-4">
                    {steps.map((s, i) => (
                        <motion.div
                            ...
                            className="relative"
                        >
                            <div className="font-display mb-6 text-7xl font-light text-primary/60 md:text-8xl">
                                {s.n}
                            </div>
                            <h3 className="font-display mb-3 text-2xl font-medium">{s.t}</h3>
                            <p className="text-foreground/65">{s.d}</p>

                            {i < steps.length - 1 && (
                                <span className="absolute right-0 top-12 hidden h-px w-12 bg-primary/30 lg:block" />
                            )}
                        </motion.div>
                    ))}
                </div>
            ...
            <div className="container-editorial">
                ...
                <div className="mt-20 flex flex-wrap items-center justify-between gap-8 border-t border-border/40 pt-10">
                    <div className="editorial-caption text-foreground/50">
                        Présentes à · Paris · Lyon · Marseille · Bordeaux · Toulouse · Lille ·
                        Rennes · Nantes · Bruxelles · Genève · Montréal
                    </div>
                    <Link href="/register" className="ghost-link text-sm font-medium text-primary">
...
function BigNumber({
    ...
    return (
        <div>
            <div className="font-display flex items-baseline gap-2 text-7xl font-light leading-none tracking-tight text-foreground md:text-8xl">
            ...
            <div className="mt-6 flex items-center gap-3 border-t border-border/40 pt-4">
                ...
                <div>
                    ...
                    <div className="editorial-caption text-foreground/50">{sub}</div>
                </div>
            </div>
        </div>
    );
                ...
                <div className="lg:col-span-4">
                    <div className="sticky top-32">
                        ...
                        <h2 className="font-display text-5xl font-light leading-[0.95] tracking-tight md:text-6xl">
                            Tout ce que tu te
                            <em className="italic text-primary"> demandais</em>.
                        </h2>
                        <p className="mt-8 max-w-sm text-foreground/65">
                            Et si tu as d&apos;autres questions, on a une vraie boîte mail. Pas un
                            chatbot.
                        </p>
                        <Link
                            href="/contact"
...
function FaqItem({ q, a }: { q: string; a: string }): JSX.Element {
    ...
    return (
        <div className="border-b border-border/50">
            ...
            >
                <span
                    className={`font-display text-xl font-light leading-snug transition-colors md:text-2xl ${
            ...
            >
                <p className="max-w-prose pb-8 pr-10 text-foreground/70">{a}</p>
            </motion.div>
        </div>
    );
}
...
function FinalCta(): JSX.Element {
    return (
        <section className="relative isolate overflow-hidden py-32 md:py-48">
            ...
            <div
                aria-hidden
                className="font-display pointer-events-none absolute inset-x-0 bottom-[-2vw] select-none text-center text-[18vw] font-light italic leading-none text-foreground/[0.06]"
            >
                viens.
            </div>

            <div className="container-editorial relative z-10 flex flex-col items-center text-center">
                <span className="editorial-eyebrow mb-8 text-primary">Final · 05</span>

                <h2 className="font-display max-w-4xl text-[clamp(2.5rem,8vw,7rem)] font-light leading-[0.92] tracking-[-0.03em]">
                    Tu as déjà
                    <br />
                    <em className="italic text-primary">trop attendu</em>.
                </h2>

                <p className="mt-10 max-w-md text-lg text-foreground/70">
                    L&apos;inscription prend trois minutes. Le reste, on verra ensemble.
                </p>
            ...
            <div className="container-editorial">
                ...
                <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-border/40 pt-8 md:flex-row md:items-center">
                    <div className="editorial-caption text-foreground/40">
                        © {new Date().getFullYear()} LesbiLibre · Tous droits réservés
                    </div>
                    <div className="editorial-caption text-foreground/40">
                        Made with intention · Pas d&apos;IA pour la modération sensible.
                    </div>
                </div>
            </div>
        </footer>
...
function FooterCol({
    ...
    return (
        <div className="md:col-span-2">
            <div className="editorial-caption mb-5 text-foreground/40">{title}</div>
