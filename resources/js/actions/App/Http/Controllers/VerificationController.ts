 ...
 * @see app/Http/Controllers/VerificationController.php:17
 * @route '/verification'
 */
 ...
 * @see app/Http/Controllers/VerificationController.php:31
 * @route '/verification'
 */
...
const VerificationController = { create, store, index, approve, reject }
