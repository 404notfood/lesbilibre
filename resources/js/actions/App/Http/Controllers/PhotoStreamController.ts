...
/**
* @see \App\Http\Controllers\PhotoStreamController::show
 * @see app/Http/Controllers/PhotoStreamController.php:23
 ...
 */
    ...
    show.form = showForm
const PhotoStreamController = { show }

export default PhotoStreamController